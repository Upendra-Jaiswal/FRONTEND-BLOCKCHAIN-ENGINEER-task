...
import {
  ...
  y
} from "./chunk-XYKWBHMU.js";
import "./chunk-F6B7MFS4.js";
import "./chunk-RXH5RMS6.js";
import "./chunk-HUFNARVE.js";
import {
  ConstantsUtil,
  NetworkUtil,
  W3mFrameConstants,
...
} from "./chunk-CPC3ZPVO.js";
import "./chunk-METRIUFS.js";
import "./chunk-GJBZJ4UL.js";
import "./chunk-I7LM4RAS.js";
...
import {
  ...
  watchConnectors,
  writeContract
} from "./chunk-G5P5IPY5.js";
import "./chunk-TJXZMLLT.js";
import {
  parseUnits
} from "./chunk-NBDJOIVP.js";
import "./chunk-Z4BR42XQ.js";
import "./chunk-4FA5FJL6.js";
import "./chunk-EWAXOTDC.js";
import "./chunk-QNEK7BXR.js";
import {
  formatUnits
} from "./chunk-UBUB3HP5.js";
  ...
  constructor(options) {
    ...
    const connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        const clientId = await ((_d = (_c = (_b = (_a = provider.signer) == null ? void 0 : _a.client) == null ? void 0 : _b.core) == null ? void 0 : _c.crypto) == null ? void 0 : _d.getClientId());
        if (clientId) {
          this.setClientId(clientId);
        }
        const chainId = NetworkUtil.caipNetworkIdToNumber((_e = this.getCaipNetwork()) == null ? void 0 : _e.id);
        const siweParams = await ((_f = siweConfig == null ? void 0 : siweConfig.getMessageParams) == null ? void 0 : _f.call(siweConfig));
        if (((_g = siweConfig == null ? void 0 : siweConfig.options) == null ? void 0 : _g.enabled) && typeof (provider == null ? void 0 : provider.authenticate) === "function" && siweParams && Object.keys(siweParams || {}).length > 0) {
          const { SIWEController, getDidChainId, getDidAddress } = await import("./exports-RH3IK6VI.js");
          ...
          const signedCacao = (_h = result == null ? void 0 : result.auths) == null ? void 0 : _h[0];
          if (signedCacao) {
      ...
      disconnect: async () => {
        ...
        if ((_a = siweConfig == null ? void 0 : siweConfig.options) == null ? void 0 : _a.signOutOnDisconnect) {
          const { SIWEController } = await import("./exports-RH3IK6VI.js");
