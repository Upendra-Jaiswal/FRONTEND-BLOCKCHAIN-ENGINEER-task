...
// node_modules/@web3modal/polyfills/node_modules/buffer/index.js
var require_buffer = __commonJS({
  "node_modules/@web3modal/polyfills/node_modules/buffer/index.js"(exports) {
    "use strict";
...
var W3mFrameProvider = class {
  ...
  onRpcRequest(callback) {
    this.w3mFrame.events.onAppEvent((event) => {
      if (event.type.includes(W3mFrameConstants.RPC_METHOD_KEY)) {
        callback(event == null ? void 0 : event.payload);
      }
    });
  }
  ...
  onGetFarcasterUriSuccess(event) {
    var _a6;
    (_a6 = this.getFarcasterUriResolver) == null ? void 0 : _a6.resolve(event.payload);
  }
  onGetFarcasterUriError(event) {
    var _a6;
    (_a6 = this.getFarcasterUriResolver) == null ? void 0 : _a6.reject(event.payload.message);
  }
  onConnectFarcasterSuccess(event) {
    ...
    (_a6 = this.connectFarcasterResolver) == null ? void 0 : _a6.resolve(event.payload);
  }
  onConnectFarcasterError(event) {
    var _a6;
    (_a6 = this.connectFarcasterResolver) == null ? void 0 : _a6.reject(event.payload.message);
  }
  ...
  async fetchTransactions(accountAddress, onramp) {
    ...
    try {
      ...
      if (onramp === "coinbase") {
        ...
        state13.transactionsByYear = this.groupTransactionsByYearAndMonth(state13.transactionsByYear, nonSpamTransactions);
      }
...
var SwapController = {
  ...
  async getInitialGasPrice() {
    ...
    return { gasPrice: gasFee, gasPriceInUSD: state16.gasPriceInUSD };
  },
  async swapTokens() {
    var _a6, _b3;
    const address = AccountController.state.address;
...
var AccountController = {
  state: state17,
  replaceState(newState) {
    Object.assign(state17, newState);
  },
  subscribe(callback) {
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CPC3ZPVO.js.map
